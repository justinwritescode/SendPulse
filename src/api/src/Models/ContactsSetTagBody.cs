...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsSetTagBody : IEquatable<ContactsSetTagBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactsSetTagBody(
            string contactId = default(string),
            Collection<string> tags = default(Collection<string>)
        )
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for ContactsSetTagBody and cannot be null"
                );
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "tags is a required property for ContactsSetTagBody and cannot be null"
                );
            }
            else
            {
