...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactChannelData : IEquatable<ContactChannelData>, IValidatableObject
    {
        /// <summary>
        ...
        public bool Equals(ContactChannelData input)
        {
            ...
            return (
                ...
                && (
                    ...
                    || (this.FirstName != null && this.FirstName.Equals(input.FirstName))
                )
                && (
                    this.LastName == input.LastName
                    || (this.LastName != null && this.LastName.Equals(input.LastName))
                )
                && (this.Name == input.Name || (this.Name != null && this.Name.Equals(input.Name)))
                && (
                    this.LanguageCode == input.LanguageCode
                    || (this.LanguageCode != null && this.LanguageCode.Equals(input.LanguageCode))
                );
        }
