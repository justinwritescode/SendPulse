...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetBotsChatsByBotIdResponse : PagedApiResponse<Chat[]>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBotsChatsByBotIdResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="data">data.</param>
        public GetBotsChatsByBotIdResponse(
            bool? success = default(bool?),
            Chat[] data = default(Chat[]),
        ...
        {
            return this.Equals(input as GetBotsChatsByBotIdResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetBotsChatsByBotIdResponse input)
        {
            if (input == null)
                return false;
