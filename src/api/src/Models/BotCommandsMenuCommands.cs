...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BotCommandsMenuCommands
        : IEquatable<BotCommandsMenuCommands>,
            IValidatableObject
    {
        /// <summary>
        ...
        public BotCommandsMenuCommands(
        ...
        public bool Equals(BotCommandsMenuCommands input)
        {
            ...
            return (
                ...
                && (
                    ...
                    || (this.Command != null && this.Command.Equals(input.Command))
                )
                && (
