...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsDisableBody : IEquatable<ContactsDisableBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactsDisableBody(string contactId = default(string))
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for ContactsDisableBody and cannot be null"
                );
            }
            else
            {
