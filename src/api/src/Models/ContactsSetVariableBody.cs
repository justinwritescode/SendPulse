...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsSetVariableBody
        : IEquatable<ContactsSetVariableBody>,
            IValidatableObject
    {
        /// <summary>
        ...
        public ContactsSetVariableBody(
            string contactId = default(string),
            string variableId = default(string),
            string variableName = default(string),
            AnyOfcontactsSetVariableBodyVariableValue variableValue =
                default(AnyOfcontactsSetVariableBodyVariableValue)
        )
        {
        ...
        public bool Equals(ContactsSetVariableBody input)
        {
            ...
            return (
                ...
                && (
                    ...
                    || (
                        this.VariableValue != null && this.VariableValue.Equals(input.VariableValue)
                    )
                );
        }
