...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsDeletePauseAutomationBody
        : IEquatable<ContactsDeletePauseAutomationBody>,
            IValidatableObject
    {
        /// <summary>
        ...
        public ContactsDeletePauseAutomationBody(string contactId = default(string))
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for ContactsDeletePauseAutomationBody and cannot be null"
                );
            }
            else
            {
