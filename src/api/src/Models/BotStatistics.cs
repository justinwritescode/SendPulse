...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BotStatistics : IEquatable<BotStatistics>, IValidatableObject
    {
        ...
        public BotStatistics(
            int? subscribedTotalCount = default(int?),
            int? subscribedActiveCount = default(int?),
            int? outgoingMessagesTotalCount = default(int?)
        )
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OutgoingMessagesTotalCount: ")
                .Append(OutgoingMessagesTotalCount)
                .Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
