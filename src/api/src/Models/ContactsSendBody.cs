...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsSendBody : IEquatable<ContactsSendBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactsSendBody(
            string contactId = default(string),
            ContactssendMessage message = default(ContactssendMessage)
        )
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for ContactsSendBody and cannot be null"
                );
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "message is a required property for ContactsSendBody and cannot be null"
                );
            }
            else
            {
