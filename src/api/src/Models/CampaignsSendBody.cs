...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignsSendBody : IEquatable<CampaignsSendBody>, IValidatableObject
    {
        /// <summary>
        ...
        public CampaignsSendBody(
            string title = default(string),
            string botId = default(string),
            string sendAt = default(string),
            Collection<CampaignssendMessages> messages = default(Collection<CampaignssendMessages>)
        )
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException(
                    "title is a required property for CampaignsSendBody and cannot be null"
                );
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "botId is a required property for CampaignsSendBody and cannot be null"
                );
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "messages is a required property for CampaignsSendBody and cannot be null"
                );
            }
            else
            {
