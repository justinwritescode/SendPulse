...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TriggerExecution : IEquatable<TriggerExecution>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="units">                         * &#x60;1&#x60; - minutes                          * &#x60;2&#x60; - hours                          * &#x60;3&#x60; - days                      .</param>
        public TriggerExecution(
            int? interval = default(int?),
            UnitsEnum? units = default(UnitsEnum?)
        )
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TriggerExecution {\n");
        ...
        {
            return this.Equals(input as TriggerExecution);
        }

        /// <summary>
        /// Returns true if TriggerExecution instances are equal
        /// </summary>
        /// <param name="input">Instance of TriggerExecution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TriggerExecution input)
        {
            if (input == null)
                return false;
            ...
            return (
                    ...
                    || (this.Interval != null && this.Interval.Equals(input.Interval))
                )
                && (
                    this.Units == input.Units
                    || (this.Units != null && this.Units.Equals(input.Units))
                );
        }
