...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsReceived
        : PagedApiResponse<Collection<Contact>>,
            IEquatable<ContactsReceived>,
            IValidatableObject
    {
        // /// <summary>
        // /// Initializes a new instance of the <see cref="ContactsReceived" /> class.
        // /// </summary>
        // /// <param name="success">success.</param>
        // /// <param name="data">data.</param>
        // public ContactsReceived(bool? success = default(bool?), Collection<Contact> data = default(Collection<Contact>))
        // {
        ...
        public Collection<Contact> Data { get; set; }
        ...
        {
            return this.Equals(input as ContactsReceived);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ContactsReceived input)
        {
            if (input == null)
                return false;
