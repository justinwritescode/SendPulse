...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowsRunByTriggerBody
        : IEquatable<FlowsRunByTriggerBody>,
            IValidatableObject
    {
        /// <summary>
        ...
        public FlowsRunByTriggerBody(
            string contactId = default(string),
            string triggerKeyword = default(string),
        ...
        )
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for FlowsRunByTriggerBody and cannot be null"
                );
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "triggerKeyword is a required property for FlowsRunByTriggerBody and cannot be null"
                );
            }
            else
            {
