...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAllBotsResponse : IEquatable<GetAllBotsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GetAllBotsResponse(
            bool? success = default(bool?),
            Collection<Bot> data = default(Collection<Bot>)
        )
        {
