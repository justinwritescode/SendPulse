...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CampaignssendMessages
        : IEquatable<CampaignssendMessages>,
            IValidatableObject
    {
        /// <summary>
        ...
        public CampaignssendMessages(
            TypeEnum? type = default(TypeEnum?),
            CampaignssendMessage message = default(CampaignssendMessage)
        )
        {
            this.Type = type;
