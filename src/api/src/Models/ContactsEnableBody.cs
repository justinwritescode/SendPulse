...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsEnableBody : IEquatable<ContactsEnableBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactsEnableBody(string contactId = default(string))
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for ContactsEnableBody and cannot be null"
                );
            }
            else
            {
