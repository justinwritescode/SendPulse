...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetBotStatisticsResponse
        : IEquatable<GetBotStatisticsResponse>,
            IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBotStatisticsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public GetBotStatisticsResponse(BotStatistics data = default(BotStatistics))
        {
            this.Data = data;
        }
        ...
        [JProp("data")]
        public BotStatistics Data { get; set; }
        ...
        {
            return this.Equals(input as GetBotStatisticsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetBotStatisticsResponse input)
        {
            if (input == null)
                return false;

            return (this.Data == input.Data || (this.Data != null && this.Data.Equals(input.Data)));
        }
