...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsDeleteTagBody
        : IEquatable<ContactsDeleteTagBody>,
            IValidatableObject
    {
        /// <summary>
        ...
        )
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for ContactsDeleteTagBody and cannot be null"
                );
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "tag is a required property for ContactsDeleteTagBody and cannot be null"
                );
            }
            else
            {
        ...
        public bool Equals(ContactsDeleteTagBody input)
        {
            ...
            return (
                ...
                ) && (this.Tag == input.Tag || (this.Tag != null && this.Tag.Equals(input.Tag)));
        }
