...
namespace SendPulse.Api.Models
{
    ...
    public partial class Chat : IEquatable<Chat>, IValidatableObject
    {
        ...
        public Chat(
            ...
            Message inboxLastMessage = default(Message),
            int? inboxUnread = default(int?)
        )
        {
        ...
        public bool Equals(Chat input)
        {
            ...
            return (
                    ...
                    || (this.Contact != null && this.Contact.Equals(input.Contact))
                )
                && (
                ...
                && (
                    ...
                    || (this.InboxUnread != null && this.InboxUnread.Equals(input.InboxUnread))
                );
        }
