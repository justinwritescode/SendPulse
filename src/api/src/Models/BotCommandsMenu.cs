...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BotCommandsMenu : IEquatable<BotCommandsMenu>, IValidatableObject
    {
        /// <summary>
        ///                      * &#x60;1&#x60; - active                      * &#x60;2&#x60; - inactive
        /// </summary>
        ...
        public BotCommandsMenu(
            StatusEnum? status = default(StatusEnum?),
            Collection<BotCommandsMenuCommands> commands =
                default(Collection<BotCommandsMenuCommands>)
        )
        {
            this.Status = status;
