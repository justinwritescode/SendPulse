...
namespace SendPulse.Api.Models
{
    ...
    public partial class Account : IEquatable<Account>, IValidatableObject
    {
        ...
        public Account(
            AccountPlan plan = default(AccountPlan),
            AccountStatistics statistics = default(AccountStatistics)
        )
        {
            this.Plan = plan;
        ...
        public bool Equals(Account input)
        {
            ...
            return (this.Plan == input.Plan || (this.Plan != null && this.Plan.Equals(input.Plan)))
                && (
                    this.Statistics == input.Statistics
                    || (this.Statistics != null && this.Statistics.Equals(input.Statistics))
                );
        }
