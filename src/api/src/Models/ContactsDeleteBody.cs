...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactsDeleteBody : IEquatable<ContactsDeleteBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactsDeleteBody(string contactId = default(string))
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for ContactsDeleteBody and cannot be null"
                );
            }
            else
            {
