...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagedMessagesResponse : PagedApiResponse<Message[]>, IValidatableObject
    {
        ///// <summary>
        ///// Initializes a new instance of the <see cref="PagedMessagesResponse" /> class.
        ///// </summary>
        ///// <param name="success">success.</param>
        ///// <param name="data">data.</param>
        //public PagedMessagesResponse(bool? success = default(bool?), Message[] data = default(Message[]))
        //{
        //    this.Success = success ?? true;
        //    this.Data = data ?? Array.Empty<Message>();
        //}
        ...
        {
            return this.Equals(input as PagedMessagesResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PagedMessagesResponse input)
        {
            if (input == null)
                return false;
