...
namespace SendPulse.Api.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlowsRunBody : IEquatable<FlowsRunBody>, IValidatableObject
    {
        /// <summary>
        ...
        public FlowsRunBody(
            ...
            object externalData = default(object)
        )
        {
            ...
            if (contactId == null)
            {
                throw new InvalidDataException(
                    "contactId is a required property for FlowsRunBody and cannot be null"
                );
            }
            else
            {
            ...
            {
                throw new InvalidDataException(
                    "flowId is a required property for FlowsRunBody and cannot be null"
                );
            }
            else
            {
        ...
        public bool Equals(FlowsRunBody input)
        {
            ...
            return (
                ...
                && (
                    ...
                    || (this.ExternalData != null && this.ExternalData.Equals(input.ExternalData))
                );
        }
