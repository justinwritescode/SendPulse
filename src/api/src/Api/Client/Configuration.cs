...
namespace SendPulse.Api.Client
{
    ...
    public class Configuration
        : SendPulse.Api.Client.Abstractions.IReadOnlyConfiguration,
            IConfiguration
    {
        public virtual void SetAccessToken(string token) => AccessToken = token;
        ...
        private static IConfiguration _globalConfiguration;

        /// <summary>Default creation of exceptions for a given method name and response object</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="Configuration" /> c</summary>
        public Configuration()
        {
            UserAgent = "Swagger-Codegen/1.0.0/csharp";
            BasePath = "https://api.sendpulse.com/telegram";
            DefaultHeader = new ConcurrentStringDictionary();
            ApiKey = new ConcurrentStringDictionary();
            ApiKeyPrefix = new ConcurrentStringDictionary();
        ...
        public Configuration(
            IStringDictionary defaultHeader,
        ...
        /// <summary>Initializes a new instance of the <see cref="Configuration" /> class with different settings</summary>
        ...
        public Configuration(
            ...
            IStringDictionary defaultHeader = null,
            string username = null,
            string password = null,
            string accessToken = null,
            IStringDictionary apiKey = null,
            IStringDictionary apiKeyPrefix = null,
        ...
        /// <param name="apiClient">Api client.</param>
        [Obsolete(
            "This constructor caused unexpected sharing of static data. It is no longer supported.",
            true
        )]
        ...
        public virtual IStringDictionary DefaultHeader { get; set; }
        ...
        /// <summary>Gets or sets the username (HTTP basic authentication).</summary>
        ...
        /// <summary>Gets or sets the prefix (e.g. Token) of the API key based on the authentication name.</summary>
        /// <value>The prefix of the API key.</value>
        public virtual IStringDictionary ApiKeyPrefix
        {
        ...
        /// <summary>Gets or sets the API key based on the authentication name.</summary>
        /// <value>The API key.</value>
        public virtual IStringDictionary ApiKey
        {
            get { return _apiKey; }
            set
            {
        ...
        /// <summary>Returns a string with essential information for debugging.</summary>
        public static string ToDebugReport()
        {
            string report = "C# SDK (SendPulse.Api) Debug Report:\n";
        ...
        /// <summary>Add Api Key Header.</summary>
        ...
        /// <summary>Sets the API key prefix.</summary>
        /// <param name="key">Api Key name.</param>
        /// <param name="value">Api Key value.</param>
