...
namespace SendPulse.Api
{
    ...
    /// </summary>
    public partial class TriggersApi : ITriggersApi
    {
        ...
        /// <returns></returns>
        public TriggersApi(SendPulse.Api.Client.Abstractions.IConfiguration configuration = null)
        {
        ...
        public ApiResponse<InlineResponse2004> TriggersGetWithHttpInfo(string botId)
        {
            ...
            if (botId == null)
                throw new ApiException(
                    400,
                    "Missing required parameter 'botId' when calling TriggersApi->TriggersGet"
                );
        ...
        {
            ApiResponse<InlineResponse2004> localVarResponse = await TriggersGetAsyncWithHttpInfo(
                botId
            );
            return localVarResponse.Data;
        }
        ...
        > TriggersGetAsyncWithHttpInfo(string botId)
        {
            // verify the required parameter 'botId' is set
            if (botId == null)
                throw new ApiException(
