...
namespace SendPulse.Api
{
    ...
    public partial class BotsApi : IBotsApi
    {
        ...
        /// <returns></returns>
        public BotsApi(SendPulse.Api.Client.Abstractions.IConfiguration configuration = null)
        {
        ...
        public PagedApiResponse<Collection<Bot>> BotsGet()
        {
            ApiResponse<PagedApiResponse<Collection<Bot>>> localVarResponse = BotsGetWithHttpInfo();
        ...
        public ApiResponse<PagedApiResponse<Collection<Bot>>> BotsGetWithHttpInfo()
        {
            ...
            return new ApiResponse<PagedApiResponse<Collection<Bot>>>(
                localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (PagedApiResponse<Collection<Bot>>)
                    this.Configuration.ApiClient.Deserialize(
                        localVarResponse,
                        typeof(PagedApiResponse<Collection<Bot>>)
                    )
            );
        }
        ...
        public async System.Threading.Tasks.Task<PagedApiResponse<Collection<Bot>>> BotsGetAsync()
        {
            ApiResponse<PagedApiResponse<Collection<Bot>>> localVarResponse =
                await BotsGetAsyncWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        {
            ApiResponse<PagedApiResponse<BotStatistics>> localVarResponse =
                BotsStatisticsGetWithHttpInfo(botId);
            return localVarResponse.Data;
        }
        ...
        )
        {
            ...
            if (botId == null)
                throw new ApiException(
                    400,
                    "Missing required parameter 'botId' when calling BotsApi->BotsStatisticsGet"
                );
            ...
            return new ApiResponse<PagedApiResponse<BotStatistics>>(
                localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (PagedApiResponse<BotStatistics>)
                    this.Configuration.ApiClient.Deserialize(
                        localVarResponse,
                        typeof(PagedApiResponse<BotStatistics>)
                    )
            );
        }
        ...
        public async System.Threading.Tasks.Task<
            PagedApiResponse<BotStatistics>
        > BotsStatisticsGetAsync(string botId)
        {
            ApiResponse<PagedApiResponse<BotStatistics>> localVarResponse =
                await BotsStatisticsGetAsyncWithHttpInfo(botId);
            return localVarResponse.Data;
        }
