...
public partial class VariablesApi : IVariablesApi
{
    ...
    /// <returns></returns>
    public VariablesApi(SendPulse.Api.Client.Abstractions.IConfiguration configuration = null)
    {
    ...
    public ApiResponse<InlineResponse2009> VariablesGetWithHttpInfo(string botId)
    {
        ...
        if (botId == null)
            throw new ApiException(
                400,
                "Missing required parameter 'botId' when calling VariablesApi->VariablesGet"
            );
        ...
        return new ApiResponse<InlineResponse2009>(
            localVarStatusCode,
    ...
    public async System.Threading.Tasks.Task<InlineResponse2009> GetVariablesByBotIdAsync(
        string botId
    )
    {
        ApiResponse<InlineResponse2009> localVarResponse =
            await GetVariablesByBoyIdAsyncWithHttpInfo(botId);
        return localVarResponse.Data;
    }
