...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class FlowsRunBody :  IEquatable<FlowsRunBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowsRunBody" /> class.
        /// </summary>
        ...
        /// <param name="flowId">Flow ID to be launched. Can be obtained with the method of obtaining the list of flows (required).</param>
        ...
        public FlowsRunBody(string contactId = default(string), string flowId = default(string), Object externalData = default(Object))
        {
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new InvalidDataException("contactId is a required property for FlowsRunBody and cannot be null");
            }
            else
            {
            ...
            if (flowId == null)
            {
                throw new InvalidDataException("flowId is a required property for FlowsRunBody and cannot be null");
            }
            else
            {
                this.FlowId = flowId;
        ...
        /// <summary>
        /// Flow ID to be launched. Can be obtained with the method of obtaining the list of flows
        /// </summary>
        /// <value>Flow ID to be launched. Can be obtained with the method of obtaining the list of flows</value>
        ...
        {
            return this.Equals(input as FlowsRunBody);
        }

        /// <summary>
        /// Returns true if FlowsRunBody instances are equal
        /// </summary>
        /// <param name="input">Instance of FlowsRunBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlowsRunBody input)
        {
            if (input == null)
                return false;
