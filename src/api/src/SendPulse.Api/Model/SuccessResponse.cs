...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class SuccessResponse :  IEquatable<SuccessResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public SuccessResponse(bool? success = default(bool?), AnyOfSuccessResponseData data = default(AnyOfSuccessResponseData))
        {
        ...
        public AnyOfSuccessResponseData Data { get; set; }
