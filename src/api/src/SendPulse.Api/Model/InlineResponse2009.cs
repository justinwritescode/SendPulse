...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse2009(bool? success = default(bool?), Variable data = default(Variable))
        {
