...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class ContactsSendBody :  IEquatable<ContactsSendBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsSendBody" /> class.
        /// </summary>
        ...
        public ContactsSendBody(string contactId = default(string), ContactssendMessage message = default(ContactssendMessage))
        {
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new InvalidDataException("contactId is a required property for ContactsSendBody and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for ContactsSendBody and cannot be null");
            }
            else
            {
        ...
        public ContactssendMessage Message { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsSendBody {\n");
        ...
        {
            return this.Equals(input as ContactsSendBody);
        }

        /// <summary>
        /// Returns true if ContactsSendBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsSendBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsSendBody input)
        {
            if (input == null)
                return false;
