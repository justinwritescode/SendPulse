...
namespace SendPulse.Api.Model
{
        ...
        internal partial class Variable :  IEquatable<Variable>, IValidatableObject
    {
        ...
        public Variable(string id = default(string), string botId = default(string), string name = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), ValueTypeEnum? valueType = default(ValueTypeEnum?), StatusEnum? status = default(StatusEnum?), string createdAt = default(string))
        {
            this.Id = id;
            this.BotId = botId;
            this.Name = name;
