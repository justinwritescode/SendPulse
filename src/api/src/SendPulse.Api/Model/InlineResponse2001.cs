...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse2001(bool? success = default(bool?), Collection<Contact> data = default(Collection<Contact>))
        {
