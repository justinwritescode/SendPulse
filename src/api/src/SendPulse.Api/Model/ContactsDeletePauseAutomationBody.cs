...
{
    /// <summary>
    /// ContactsDeletePauseAutomationBody
    /// </summary>
    [DataContract]
        internal partial class ContactsDeletePauseAutomationBody :  IEquatable<ContactsDeletePauseAutomationBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsDeletePauseAutomationBody" /> class.
        /// </summary>
        ...
        public ContactsDeletePauseAutomationBody(string contactId = default(string))
        {
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new InvalidDataException("contactId is a required property for ContactsDeletePauseAutomationBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsDeletePauseAutomationBody {\n");
        ...
        {
            return this.Equals(input as ContactsDeletePauseAutomationBody);
        }

        /// <summary>
        /// Returns true if ContactsDeletePauseAutomationBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsDeletePauseAutomationBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsDeletePauseAutomationBody input)
        {
            if (input == null)
                return false;
