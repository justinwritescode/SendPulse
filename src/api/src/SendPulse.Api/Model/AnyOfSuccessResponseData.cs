...
{
    /// <summary>
    /// AnyOfSuccessResponseData
    /// </summary>
    [DataContract]
        internal partial class AnyOfSuccessResponseData :  IEquatable<AnyOfSuccessResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOfSuccessResponseData" /> class.
        /// </summary>
        public AnyOfSuccessResponseData()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyOfSuccessResponseData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnyOfSuccessResponseData);
        }

        /// <summary>
        /// Returns true if AnyOfSuccessResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyOfSuccessResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyOfSuccessResponseData input)
        {
            if (input == null)
                return false;
