...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class ContactsEnableBody :  IEquatable<ContactsEnableBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsEnableBody" /> class.
        /// </summary>
        ...
        public ContactsEnableBody(string contactId = default(string))
        {
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new InvalidDataException("contactId is a required property for ContactsEnableBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsEnableBody {\n");
        ...
        {
            return this.Equals(input as ContactsEnableBody);
        }

        /// <summary>
        /// Returns true if ContactsEnableBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsEnableBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsEnableBody input)
        {
            if (input == null)
                return false;
