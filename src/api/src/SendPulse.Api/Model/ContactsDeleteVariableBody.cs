...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class ContactsDeleteVariableBody :  IEquatable<ContactsDeleteVariableBody>, IValidatableObject
    {
        /// <summary>
        ...
        public ContactsDeleteVariableBody(string contactId = default(string), string variableId = default(string), string variableName = default(string))
        {
