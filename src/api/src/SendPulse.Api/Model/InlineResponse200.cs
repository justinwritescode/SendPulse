...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class ContactReceived :  IEquatable<ContactReceived>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactReceived" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="data">data.</param>
        public ContactReceived(bool? success = default(bool?), Contact data = default(Contact))
        {
        ...
        {
            return this.Equals(input as ContactReceived);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ContactReceived input)
        {
            if (input == null)
                return false;
