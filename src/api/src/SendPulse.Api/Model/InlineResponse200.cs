...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse200(bool? success = default(bool?), Contact data = default(Contact))
        {
