...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class Campaign :  IEquatable<Campaign>, IValidatableObject
    {
        /// <summary>
        ...
        public Campaign(string id = default(string), string botId = default(string), string title = default(string), string sendAt = default(string), Collection<Object> messages = default(Collection<Object>), string createdAt = default(string))
        {
            this.Id = id;
            this.BotId = botId;
            this.Title = title;
