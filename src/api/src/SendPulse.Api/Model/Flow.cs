...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class Flow :  IEquatable<Flow>, IValidatableObject
    {
        /// <summary>
        ///                      * &#x60;1&#x60; - active                      * &#x60;2&#x60; - inactive                  
        /// </summary>
        ...
        public Flow(string id = default(string), string botId = default(string), string name = default(string), StatusEnum? status = default(StatusEnum?), Collection<FlowTriggers> triggers = default(Collection<FlowTriggers>), string createdAt = default(string))
        {
            this.Id = id;
            this.BotId = botId;
            this.Name = name;
        ...
        public Collection<FlowTriggers> Triggers { get; set; }
