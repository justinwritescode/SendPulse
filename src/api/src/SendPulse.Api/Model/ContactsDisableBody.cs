...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class ContactsDisableBody :  IEquatable<ContactsDisableBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsDisableBody" /> class.
        /// </summary>
        ...
        public ContactsDisableBody(string contactId = default(string))
        {
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new InvalidDataException("contactId is a required property for ContactsDisableBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsDisableBody {\n");
        ...
        {
            return this.Equals(input as ContactsDisableBody);
        }

        /// <summary>
        /// Returns true if ContactsDisableBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsDisableBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsDisableBody input)
        {
            if (input == null)
                return false;
