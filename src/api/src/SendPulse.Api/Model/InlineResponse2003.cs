...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponse2003(bool? success = default(bool?), Flow data = default(Flow))
        {
