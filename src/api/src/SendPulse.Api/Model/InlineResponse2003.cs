...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    internal partial class GetFlowsByBotResponse :  IEquatable<GetFlowsByBotResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFlowsByBotResponse" /> class.
        /// </summary>
        /// <param name="success">success.</param>
        /// <param name="data">data.</param>
        public GetFlowsByBotResponse(bool? success = default(bool?), Flow data = default(Flow))
        {
        ...
        {
            return this.Equals(input as GetFlowsByBotResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(GetFlowsByBotResponse input)
        {
            if (input == null)
                return false;
