...
namespace SendPulse.Api.Model
{
    ...
    /// </summary>
    [DataContract]
        internal partial class ContactsDeleteBody :  IEquatable<ContactsDeleteBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsDeleteBody" /> class.
        /// </summary>
        ...
        public ContactsDeleteBody(string contactId = default(string))
        {
            // to ensure "contactId" is required (not null)
            if (contactId == null)
            {
                throw new InvalidDataException("contactId is a required property for ContactsDeleteBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactsDeleteBody {\n");
        ...
        {
            return this.Equals(input as ContactsDeleteBody);
        }

        /// <summary>
        /// Returns true if ContactsDeleteBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactsDeleteBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactsDeleteBody input)
        {
            if (input == null)
                return false;
